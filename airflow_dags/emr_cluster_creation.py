...
def create_cluster(region_name, cluster_name='AbhinavA_Cluster_' + str(datetime.now()), release_label='emr-6.2.1',master_instance_type='m5.xlarge', num_core_nodes=1, core_node_instance_type='m5.xlarge'):
    ...
    cluster_response = emr.run_job_flow(
        ...
        "BootstrapActions" = [
                {
                    ...
                    'ScriptBootstrapAction': {
                            'Path': 's3://abhinavanandrawzone/dependencies/python_dependencies.sh',
                        }
                }
            ],
        ...
        JobFlowRole='aa_ec2emr',
        ServiceRole='aa_emrAdmin',
        Applications=[
            { 'Name': 'hadoop' },
            { 'Name': 'spark' },
            { 'Name': 'hive' },
